...
User.getFavbooks = (userId, result) => {
    const strQuery = `SELECT bf.id,title,isRead,image,favOrder FROM userbooksfav bf INNER JOIN  book b ON bf.bookId = b.id WHERE bf.userId = ${userId} ORDER BY bf.favOrder`
